...
//
    ...
    { eng: "He's an alley cat", rus: "Он дворовой кот" },
    ...
    { eng: "What will do today?", rus: "Что будешь делать сегодня?" },
    ...
    { eng: "Nurses have low salaries", rus: "У медсестер низкая зарплата" },
    { eng: "Doesn't work as a nurse", rus: "Не работает медсестрой" },
