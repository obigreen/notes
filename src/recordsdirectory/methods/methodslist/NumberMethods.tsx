...
export const numberItems = [
    {
        highlight: ".toFixed()",
        isTop: true,
        content: "Возвращает строку с фиксированным количеством цифр после десятичной точки. Не является locale-форматированием и наследует особенности IEEE-754 округления",
        code:
            `
        //code
        //.toFixed(digits)
        ...
        //Для денежных значений учитывай двоичную точность Number:
    ...
    },
    {
        ...
        isTop: true,
        content: "Возвращает строку с указанным общим количеством значащих цифр; при необходимости использует экспоненциальную запись",
        code:
            `
        //code
    ...
    },
    {
        highlight: ".toString()",
        isTop: true,
        content: "Возвращает строковое представление числа; необязательный radix задает систему счисления от 2 до 36",
        code:
            `
        //code
        //.toString([radix])
    ...
    {
        highlight: ".valueOf()",
        content: "Возвращает примитивное number-значение объекта-обертки Number. В прикладном коде обычно лучше не создавать Number через new",
        code:
            `
        //code
